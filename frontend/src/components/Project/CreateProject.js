          ...
          <div className="layout-content-container flex flex-col max-w-[960px] w-full">
            ...
            <div className="flex px-4 py-3 justify-center w-full">
              <button
                ...
                className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#0074D9] text-white text-sm leading-normal tracking-[0.015em]"
            ...
            <div className="flex px-4 py-3 justify-center w-full">
              <button
                ...
                className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#AAAAAA] text-white text-sm leading-normal tracking-[0.015em]"
              >
